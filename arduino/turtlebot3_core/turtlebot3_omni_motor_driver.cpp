...
Turtlebot3MotorDriverOmni::Turtlebot3MotorDriverOmni()
: baudrate_(BAUDRATE),
...
bool Turtlebot3MotorDriverOmni::init(void)
{
...
bool Turtlebot3MotorDriverOmni::setTorque(uint8_t id, bool onoff)
{
  uint8_t dxl_error = 0;
...
void Turtlebot3MotorDriverOmni::closeDynamixel(void)
{
...
bool Turtlebot3MotorDriverOmni::controlMotor(int64_t first_wheel_value, int64_t second_wheel_value, int64_t third_wheel_value)
{
