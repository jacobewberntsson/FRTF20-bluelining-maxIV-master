...
void loop()
{
  ...
  updateGoalVelocity();
  motor_driver.controlMotor((int64_t)(goal_velocity[0] * 100), (int64_t) (goal_velocity[1] * 100), (int64_t) (goal_velocity[2] * 100));
  ...
  //{
    ...
    //{
      //motor_driver.controlMotor((int64_t) 0, (int64_t) 0, (int64_t) 0);
    //} 
    //else {
      //motor_driver.controlMotor((int64_t)goal_velocity[0], (int64_t)goal_velocity[1], (int64_t)goal_velocity[2]);
    //}
    //tTime[0] = t;
  //}
...
void commandVelocityCallback(const geometry_msgs::Twist& cmd_vel_msg)
{
  ...
  goal_velocity_from_cmd[0] =  cmd_vel_msg.linear.y - cmd_vel_msg.angular.z;
  goal_velocity_from_cmd[1] =  cmd_vel_msg.linear.x - cmd_vel_msg.linear.y/2 - cmd_vel_msg.angular.z;
  goal_velocity_from_cmd[2] =  -cmd_vel_msg.linear.x - cmd_vel_msg.linear.y/2 - cmd_vel_msg.angular.z;
...
void motorPowerCallback(const std_msgs::Bool& power_msg)
{
  ...
  //motor_driver.setTorque((uint8_t) 0, dxl_power);
  //motor_driver.setTorque((uint8_t) 1, dxl_power);
  //motor_driver.setTorque((uint8_t) 2, dxl_power);
}
...
{
  cmd_vel_rc100_msg.linear.x  = goal_velocity_from_rc100[0];
  cmd_vel_rc100_msg.linear.y = goal_velocity_from_rc100[1];
  cmd_vel_rc100_msg.angular.z = goal_velocity_from_rc100[2];
...
{
  goal_velocity[0] = goal_velocity_from_cmd[0];
  goal_velocity[1] = goal_velocity_from_cmd[1];
  goal_velocity[2] = goal_velocity_from_cmd[2];

  //sensors.setLedPattern(goal_velocity[0], goal_velocity[1], goal_velocity[2]);
}
